...
from mlx.warnings import PolyspaceSubChecker, WarningsPlugin, warnings_wrapper
...
class TestCodeProverWarnings(unittest.TestCase):
    def setUp(self):
        ...
        self.dut.checkers = [
            PolyspaceSubChecker("run-time check", "color", "red"),
            PolyspaceSubChecker("run-time check", "color", "orange"),
        ]
...
class TestBugFinderWarnings(unittest.TestCase):
    def setUp(self):
        ...
        self.dut = self.warnings.activate_checker_name('polyspace')
        self.dut.checkers = [
            PolyspaceSubChecker("defect", "information", "impact: high"),
            PolyspaceSubChecker("defect", "information", "impact: medium"),
            PolyspaceSubChecker("defect", "information", "impact: low"),
        ]
