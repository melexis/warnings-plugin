...
class TestSphinxWarnings(TestCase):
    ...
    def test_single_warning(self):
        dut = "/home/bljah/test/index.rst:5: WARNING: toctree contains reference to nonexisting document "\
              "u'installation'"
    ...
    def test_warning_no_line_number(self):
        dut1 = "/home/bljah/test/index.rst:5: WARNING: toctree contains reference to nonexisting document "\
               "u'installation'"
        dut2 = "/home/bljah/test/index.rst:None: WARNING: toctree contains reference to nonexisting document "\
               "u'installation'"
        dut3 = "/home/bljah/test/index.rst:: WARNING: toctree contains reference to nonexisting document "\
               "u'installation'"
    ...
    def test_single_warning_mixed(self):
        ...
        dut2 = "/home/bljah/test/index.rst:5: WARNING: toctree contains reference to nonexisting document "\
               "u'installation'"
    ...
    def test_multiline(self):
        duterr1 = "/home/bljah/test/index.rst:5: WARNING: toctree contains reference to nonexisting document "\
                  "u'installation'\n"
        duterr2 = "/home/bljah/test/index.rst:None: WARNING: toctree contains reference to nonexisting document "\
                  "u'installation'\n"
    ...
    def test_warning_no_docname(self):
        duterr1 = "WARNING: List item 'CL-UNDEFINED_CL_ITEM' in merge/pull request 138 is not defined as a "\
                  "checklist-item.\n"
