...
class TestDoxygenWarnings(TestCase):
    ...
    def test_single_warning(self):
        dut = "testfile.c:6: warning: group test: ignoring title \"Some test functions\" that does not match "\
    ...
    def test_single_warning_mixed(self):
        ...
        dut2 = "testfile.c:6: warning: group test: ignoring title \"Some test functions\" that does not match "\
               "old title \"Some freaky test functions\""
    ...
    def test_multiline(self):
        duterr1 = "testfile.c:6: warning: group test: ignoring title \"Some test functions\" that does not match "\
                  "old title \"Some freaky test functions\"\n"
        duterr2 = "testfile.c:8: warning: group test: ignoring title \"Some test functions\" that does not match "\
                  "old title \"Some freaky test functions\"\n"
    ...
    def test_sphinx_deprecation_warning(self):
        duterr1 = "testfile.c:6: warning: group test: ignoring title \"Some test functions\" that does not match "\
                  "old title \"Some freaky test functions\"\n"
        dut = "/usr/local/lib/python3.5/dist-packages/sphinx/application.py:402: RemovedInSphinx20Warning: "\
